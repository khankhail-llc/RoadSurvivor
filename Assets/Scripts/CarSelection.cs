...
public class CarSelection : MonoBehaviour
{
    ...
    private int totalCars = 23; // Default fallback
    ...
    private void Start()
    {
        ...
        if (carPrices == null || carPrices.Length < totalCars)
        {
            ...
            int[] defaultPrices = new int[] { 0, 30, 500, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000, 5500, 6000, 6500, 7000, 7500, 8000,8500,9000,9500,10000,10500};
